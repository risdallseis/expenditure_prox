...
"""Big copy paste job from stackoverflow
"""
...
def show_results(
    ...
    ax[0].bar(list(range(1,no_features+1)),evecs[0])
    plt.setp(ax[0], title="First and Second Component's Eigenvectors ", ylabel='Weight')
    ax[1].bar(list(range(1,no_features+1)),evecs[1])
